...
public class T714 {
    ...
    public static void main(String[] args) {
        println(maxProfit(new int[]{1, 3, 2, 8, 4, 9}, 2)); // 8

        println(SuperGuPiao.calMaxProfitWithFee(new int[] {1, 3, 2, 8, 4, 9}, 2, 1));   // 6
    }

    private static int maxProfit(int[] prices, int fee) {
        return SuperGuPiao.calMaxProfitWithFee(prices, fee, Integer.MAX_VALUE);
    }
