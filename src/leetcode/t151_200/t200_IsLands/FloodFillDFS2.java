...
public class FloodFillDFS2 implements INumIslands {
    ...
    private static int floodFillDFS(char[][] grid, int row, int col, Set<Point> visited, int maxX, int maxY) {
        ...
        floodFillDFS(grid, row - 1, col, visited, maxX, maxY);
        floodFillDFS(grid, row + 1, col, visited, maxX, maxY);
        floodFillDFS(grid, row, col - 1, visited, maxX, maxY);
        floodFillDFS(grid, row, col + 1, visited, maxX, maxY);
